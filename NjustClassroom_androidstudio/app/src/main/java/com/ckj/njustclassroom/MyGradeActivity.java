...
public class MyGradeActivity extends Activity {
	...
	public static final String PREFS_NAME = "prefs2"; // 设置preference名称
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		bnLogin.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (validate()) {
					mDialog = new ProgressDialog(MyGradeActivity.this);
					mDialog.setTitle("登陆");
	...
	Handler handler = new Handler() {
		public void handleMessage(Message msg) {
			...
			case 1:
				mDialog.cancel();
				Toast.makeText(MyGradeActivity.this, "用户名或密码错误，请重新输入！",
						Toast.LENGTH_LONG).show();
				break;
			case 2:
				mDialog.cancel();
				// 切换布局文件
				setContentView(R.layout.mygrade2);
				...
				bt0.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						...
						String url = "http://219.230.100.200:6666/pls/wwwbks/bkscjcx.curscopre";
						Thread thread1 = new Thread(new newThread(url));
						thread1.start();
					}
				...
				bt1.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						...
						String url = "http://219.230.100.200:6666/pls/wwwbks/bkscjcx.tsjykcx";
						Thread thread1 = new Thread(new newThread(url));
						thread1.start();
					}
				...
				bt2.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						...
						String url = "http://219.230.100.200:6666/pls/wwwbks/bkscjcx.xkjykcx";
						Thread thread1 = new Thread(new newThread(url));
						thread1.start();
					}
				...
				bt3.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						...
						String url = "http://219.230.100.200:6666/pls/wwwbks/bkscjcx.zyjckcx";
						Thread thread1 = new Thread(new newThread(url));
						thread1.start();
					}
				...
				bt4.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						...
						String url = "http://219.230.100.200:6666/pls/wwwbks/bkscjcx.zyfxkcx";
						Thread thread1 = new Thread(new newThread(url));
						thread1.start();
					}
				...
				bt5.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						...
						String url = "http://219.230.100.200:6666/pls/wwwbks/bkscjcx.zyxxkcx";
						Thread thread1 = new Thread(new newThread(url));
						thread1.start();
					}
				...
				bt6.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						...
						String url = "http://219.230.100.200:6666/pls/wwwbks/bkscjcx.rwszkcx";
						Thread thread1 = new Thread(new newThread(url));
						thread1.start();
					}
				...
				bt7.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						...
						mDialog.setMessage("正在查询，请稍后...");
						mDialog.show();
						String url = "http://219.230.100.200:6666/pls/wwwbks/bkscjcx.kxszkcx";
						Thread thread1 = new Thread(new newThread(url));
						thread1.start();
					}
				...
				bt8.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						...
						mDialog.setMessage("正在查询，请稍后...");
						mDialog.show();
						String url = "http://219.230.100.200:6666/pls/wwwbks/bkscjcx.wgyykcx";
						Thread thread1 = new Thread(new newThread(url));
						thread1.start();
					}
	...
	public static String loginServer(String username, String password) {
		String result = null;
		String url = "http://219.230.100.200:6666/pls/wwwbks/bkscjcx.login";
